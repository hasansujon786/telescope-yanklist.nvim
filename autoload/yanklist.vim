...
" noremap <silent> <expr> <Plug>(yanklist-startput) yanklist#startput("p",0)
" noremap <silent> <expr> <Plug>(yanklist-startPut) yanklist#startput("P",0)
" noremap <silent> <expr> <Plug>(yanklist-autoput) yanklist#startput("p",1)
" noremap <silent> <expr> <Plug>(yanklist-autoPut) yanklist#startput("P",1)
" noremap <silent> <Plug>(yanklist-cycle) :<c-u>call yanklist#cycle(1)<cr>
" noremap <silent> <Plug>(yanklist-cycleback) :<c-u>call yanklist#cycle(-1)<cr>

" map p <Plug>(yanklist-autoput)
" map P <Plug>(yanklist-autoPut)

" map <leader>ii <Plug>(yanklist-startput)
" map <leader>ii <Plug>(yanklist-startPut)

" map <A-n> <Plug>(yanklist-cycle)
" map <A-p> <Plug>(yanklist-cycleback)
